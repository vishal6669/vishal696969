...
import {
  ...
  Grid3X3, AlertTriangle, FileText, Upload, Settings, LogOut,
...
const NAV_ITEMS = [
  ...
  { to: '/admin/portfolios', label: 'Student Portfolios', icon: FileText },
  { to: '/admin/companies', label: 'Company Cutoffs', icon: Building2 },
  { to: '/admin/placement-analytics', label: 'Placement Analytics', icon: TrendingUp },
  { to: '/admin/dept-analytics', label: 'Department Analytics', icon: GitBranch },
  { to: '/admin/skill-heatmap', label: 'Skill Gap Heatmap', icon: Grid3X3 },
  { to: '/admin/at-risk', label: 'At-Risk Students', icon: AlertTriangle },
  { to: '/admin/reports', label: 'Reports', icon: FileText },
  { to: '/admin/data-upload', label: 'Data Upload', icon: Upload },
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-50 flex flex-col">
      <UnifiedHeader currentRole="admin" />
        ...
        <div className="p-5 border-b border-surface-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-surface-500 font-medium">Admin / TPO Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-surface-100">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-surface-500">TPO Admin</p>
            </div>
          </div>
